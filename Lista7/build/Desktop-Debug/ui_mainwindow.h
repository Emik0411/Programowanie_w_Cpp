...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/img/media-playback-pause.png"), QSize(), QIcon::Normal, QIcon::Off);
        przycisk->setIcon(icon2);
